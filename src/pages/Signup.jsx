...
export default function Signup({ onSignup, onSwitchToLogin, onBack }) {
  ...
  const handleSubmit = async (e) => {
    ...
    setError("");
    setLoading(true);
    await onSignup({ username, email, password }, (err) => {
      if (err) setError(err);
      setLoading(false);
    });
  };
  ...
  return (
    <div style={styles.modalOverlay}>
      <div style={styles.modalCard}>
        ...
        <p style={styles.subtitle}>Submit your details for admin approval.</p>
...
const styles = {
  ...
  badge: { fontSize: "11px", letterSpacing: "1.5px", color: "#818CF8", fontWeight: "700", marginBottom: "8px", textTransform: "uppercase" },
